...
<!-- Remove this line -->
<!-- <link rel="preload" href="{{ asset('build/assets/') }}" as="style"> -->

    <!-- Vite will handle asset preloading -->
...
<body class="min-h-screen bg-gradient-to-br from-indigo-50 to-white antialiased">
    <!-- Loading overlay removed for testing -->
    ...
    <div class="min-h-screen flex flex-col">
                    ...
                    @if (Route::has('login'))
                        <div class="flex items-center space-x-4">
                            ...
                            <div id="nav-links" class="hidden md:flex items-center space-x-4">
                                <a href="#features" class="text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-2 rounded-md">
                                    Features
                                </a>
                                <a href="#how-it-works" class="text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-2 rounded-md">
                                    How It Works
                                </a>
                                @auth
                                ...
                                @else
                                    <a href="{{ route('login') }}" class="text-gray-700 hover:text-indigo-600 transition-colors duration-200 px-3 py-2 rounded-md">
                                        Log in
                                    </a>
        ...
        <a href="#main-content" class="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 bg-indigo-600 text-white px-4 py-2 rounded z-50">
                ...
                <div class="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
                    ...
                    <div class="mb-12 lg:mb-0">
                        ...
                        <p class="text-xl text-gray-600 mb-8">
                            A single sign-on solution that makes authentication simple, secure, and seamless across all your applications.
                        </p>
                        ...
                        <!-- Trusted by -->
                        <div class="mt-12">
                            <p class="text-sm font-medium text-gray-500 mb-4">TRUSTED BY TEAMS AT</p>
                            <div class="flex flex-wrap items-center gap-6">
                                <div class="text-2xl font-bold text-gray-400">ACME</div>
                                <div class="text-2xl font-bold text-gray-400">XYZ Corp</div>
                                <div class="text-2xl font-bold text-gray-400">123 Industries</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="auth-card">
                        <div class="p-8">
                            ...
                            <div class="space-y-4">
                                <a href="{{ route('login.microsoft') }}" class="w-full flex items-center justify-center gap-2 btn-outline">
                                ...
                                <a href="{{ route('login.azure') }}" class="w-full flex items-center justify-center gap-2 btn-outline">
                                    <svg class="w-5 h-5" viewBox="0 0 21 21" fill="#0078D4">
        ...
        <!-- Features Section -->
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16">
                        ...
                        <p class="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
                            Our SSO solution provides a seamless and secure way to manage access to all your applications.
                        </p>
                    </div>
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <div class="feature-card">
                            ...
                            <h3 class="text-lg font-medium text-gray-900 mb-2">Secure Access</h3>
                            <p class="text-gray-600">Enterprise-grade security with multi-factor authentication and single sign-on.</p>
                        </div>
                        ...
                        <div class="feature-card">
                            ...
                            <h3 class="text-lg font-medium text-gray-900 mb-2">Easy Integration</h3>
                            <p class="text-gray-600">Seamlessly connect with hundreds of applications and services.</p>
                        </div>
            ...
            <svg class="w-[448px] max-w-none relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] hidden dark:block" viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M100 100L400 100L250 300Z" fill="#f3f4f6" stroke="#e5e7eb" stroke-width="1"/>
